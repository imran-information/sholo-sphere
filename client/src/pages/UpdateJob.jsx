...
const UpdateJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`${import.meta.env.VITE_API}/update-job/${id}`, formData)
      
      toast.success('Successfully Updated job!')
      navigate('/my-posted-jobs')
    }
    catch (err) {
      console.error("Error in JobCard:", err.message);
    }


  }

  // const { title, description, category, max_price, min_price } = job || {}
